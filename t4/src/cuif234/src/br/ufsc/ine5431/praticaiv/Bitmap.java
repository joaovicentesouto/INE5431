...
import cuif234.src.br.ufsc.ine5431.huffmancoding.HuffmanCoding;
...
public class Bitmap {
    ...
    private void cuif3toRaster(byte[] cuiffile, int index) throws IOException {
    	...
    	byte[] data = cuif234.src.br.ufsc.ine5431.huffmancoding.HuffmanCoding.decompression(compresseddata);
    ...
    private void cuif4toRaster(byte[] cuiffile, int index) {
    	...
    	// Descompacta RLE
    	byte [] data = cuif234.src.br.ufsc.ine5431.rlecoding.RLECoding.decompress(compressedRLE);
